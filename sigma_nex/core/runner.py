...
class Runner:
    ...
    def __init__(self, config: Dict[str, Any], secure: bool = False, max_history: Optional[int] = None, model_name: Optional[str] = None):
        """
...
SIGMA-NEX Statistics:
  ...
  Max history limit: {self.max_history * 2}
    ...
    def self_check(self) -> None:
        ...
        if not self._ollama_cli_available:
            echo("⚠️ Ollama CLI not found; HTTP API may still be available at localhost:11434")
            return
        try:
