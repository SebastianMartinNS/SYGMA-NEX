...
class TestSigmaConfigRealistic:
    ...
    def test_find_project_root_fallback_real(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                # Dovrebbe usare fallback (parent.parent.parent di __file__)
                expected_fallback = Path(__file__).parent.parent.parent
                assert config.project_root == expected_fallback
    ...
    def test_framework_loading_existing_file_real(self):
        ...
        framework_data = {
            ...
            "version": "1.0",
            "modules": [
                {"id": "survival_001", "name": "Water Procurement", "category": "survival"},
                {"id": "navigation_001", "name": "GPS Navigation", "category": "navigation"}
            ]
        }
...
class TestConfigIntegration:
    ...
    def test_config_path_resolution_integration_real(self):
        ...
        paths_to_test = ['framework', 'models', 'translate_models', 'data', 'logs', 'temp']
    ...
    def test_config_robust_fallbacks_real(self):
        ...
        try:
            with patch('builtins.print'):  # Sopprime warning
                ...
                assert config.get('debug') == False  # Default, non True dal file corrotto
