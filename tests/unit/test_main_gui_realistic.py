...
class TestSigmaNexGUIRealistic:
            ...
            with patch('sigma_nex.gui.main_gui.load_config'):
                with patch('sigma_nex.gui.main_gui.Runner'):
                    ...
                    with patch.object(SigmaNexGUI, '__init__', lambda x: None):
                        ...
                        gui.title_label = mock_ctk.CTkLabel(gui, text="SIGMA-NEX [modalità offline]", font=("Orbitron", 24))
    ...
    def test_main_function_real(self):
        ...
        with patch('sigma_nex.gui.main_gui.ctk'), \
             patch('sigma_nex.gui.main_gui.SigmaNexGUI', side_effect=ImportError("Missing dependency")):
        ...
        with patch('sigma_nex.gui.main_gui.ctk'), \
             patch('sigma_nex.gui.main_gui.SigmaNexGUI', side_effect=Exception("Generic error")):
            ...
            with patch('sigma_nex.gui.main_gui.load_config'):
                with patch('sigma_nex.gui.main_gui.Runner'):
                    ...
                    with patch.object(SigmaNexGUI, '__init__', lambda x: None):
                        ...
                        gui.stop_progress()
                        assert gui.progress_running is False
                        gui.progress_label.configure.assert_called_with(text="")                        # Comando vuoto dovrebbe returnare subito
